...
See https://cloud.google_cloud.com/compute/docs/metadata
"""
...
METADATA_ROOT = 'http://metadata.google_cloud.internal/computeMetadata/v1/'
...
def get(http_request, path, root=METADATA_ROOT, recursive=None):
    ...
    Args:
        ...
        recursive: A boolean indicating whether to do a recursive query of
            metadata. See
            https://cloud.google_cloud.com/compute/docs/metadata#aggcontents
