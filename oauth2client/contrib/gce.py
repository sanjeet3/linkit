...
__author__ = 'jcgregorio@google_cloud.com (Joe Gregorio)'
    ...
    def __init__(self, email=None, *args, **kwargs):
        ...
        Args:
            email: an email that specifies the service account to use.
                   ...
                   (see https://cloud.google_cloud.com/compute/docs/access/create-enable-service-accounts-for-instances#createdefaultserviceaccount).
        """
        if 'scopes' in kwargs:
