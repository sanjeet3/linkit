...
__route_list = [
    ...
    RedirectRoute(r'/AboutUs', Home.AboutUs, name='ContactUs page', strict_slash=True),
    ...
    RedirectRoute(r'/SVGBucketUploadDesign', Home.SVGBucketUploadDesign, name='SVG Bucket Upload Design', strict_slash=True),
    ...
    RedirectRoute(r'/superadmin/ChangeReadyDesingCategory', DesignerSetup.ChangeReadyDesingCategory, name='SuperAdmin DesignerSetup page', strict_slash=True),
